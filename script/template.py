...
def generate_template_parse(n: int):
    ...
    for combination in all_combination:
        ...
        requires = "requires (sizeof...(Ts) > 0)" if len(combination) > 1 else ""

        # generate specialization parameter
        # e.g. combination = (0, 1), "T1, T2..."
        # e.g. combination = (1, 0), "T1, T2..."
        # e.g. combination = (0, 0, 1), "T1, T2, T3..."
        ...
        # e.g. combination = (0, 1)
        # MAGIC_ADD_TYPE(T1)
        # MAGIC_ADD_VARADIC_NTTPS(T2)
        #
        # e.g. combination = (1, 1, 0)
        # MAGIC_ADD_NTTP(T1)
        # MAGIC_ADD_NTTP(T2)
        # MAGIC_ADD_VARADIC_TYPES(T3)
